...
// Service Worker — AXIS-NIDDHI Engine v3.0.0
...
const CACHE_VERSION = 'v3.0.0';                                    // [20260414]
const CACHE_NAME    = `axis-niddhi-${CACHE_VERSION}`;            // [20260414]
    ...
    event.waitUntil(
        caches.keys()
            .then(cacheNames => Promise.all(
                cacheNames
                    .filter(name => name.startsWith('axis-niddhi-') && name !== CACHE_NAME)
                    .map(name => {
